...
{
    public partial class ViewAssessmentYearSummary : System.Web.UI.Page
    {
        ...
        void calReport()
        {
            ...
            XtraRepAssessmentYearSummary obj_Rpt = new XtraRepAssessmentYearSummary();
        ...
        {
            ViewAssessmentYearSummary vp = new ViewAssessmentYearSummary();
