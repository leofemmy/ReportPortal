<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewTccYearSummaryChild.aspx.cs" Inherits="ReportPortal.ViewTccYearSummaryChild" %>
    ...
    <script type="text/javascript" id="script">
        function previewClick(s, e) {
            ...
            if (e.Brick.text() != null) {
                window.location.href = "ViewTccYearSummaryChildDetails.aspx"
            }
        }
    </script>
</head>
