<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewAssessmentYearSummaryChild.aspx.cs" Inherits="ReportPortal.ViewAssessmentYearSummaryChild" %>
    ...
    <script type="text/javascript" id="script">
        function previewClick(s, e) {
            ...
            if (e.Brick.text() != null) {
                window.location.href = "ViewAssessmentYearSummaryChildDetails.aspx"
            }
        }
    </script>
</head>
