<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewAssessmentCummulativeSummaryChild.aspx.cs" Inherits="ReportPortal.ViewAssessmentCummulativeSummaryChild" %>
    ...
    <script type="text/javascript" id="script">
        function previewClick(s, e) {
            ...
            if (e.Brick.text() != null) {
                window.location.href = "ViewAssessmentCummulativeSummaryChildDetails.aspx"
            }
        }
    </script>
</head>
