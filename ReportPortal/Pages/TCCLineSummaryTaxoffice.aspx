<%@ Page Title="" Language="C#" MasterPageFile="~/PortalSite.Master" AutoEventWireup="true" CodeBehind="TCCLineSummaryTaxoffice.aspx.cs" Inherits="ReportPortal.TCCLineSummaryTaxoffice" %>
    ...
    <div class="col-sm-6 col-xs-12">
        <div class="panel panel-default card-view">
            <div class="panel-heading">
                <div class="pull-left">
                    <h6 class="panel-title txt-dark">TCC Line Summary By Tax Office </h6>
                </div>
                    ...
                    <div class="form-wrap">
                        <form class="form-horizontal" runat="server">
                            <div class="form-group">
                                <asp:Label ID="Label2" class="control-label mb-10 col-sm-2" runat="server" Text="Year"></asp:Label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <asp:DropDownList ID="ddlRevenue" CssClass="form-control select2-selection--multiple" runat="server"></asp:DropDownList>
                                </div>
                            </div>
