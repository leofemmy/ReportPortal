<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgotpassword.aspx.cs" Inherits="ReportPortal.forgotpassword" %>
...
<head runat="server">
    ...
    <meta name="keywords" content="report, portal, report portal" />
                    ...
                    <div class="mt-40">
                        <div class="main-title on-dark text-center mb-0">
                            <a href="index.html" class="text-center db">
                                ...
                                <%--<span class="brand-text">[ Hyrax<strong>UX</strong> ]</span> </a>--%>
                        ...
                        <form class="form-horizontal form-material" id="loginform" runat="server">
                            <div class="form-group mt-20">
                                <div class="col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" runat="server" id="txtpassword" class="form-control" placeholder="Email Address">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group text-center mb-10">
                                <div class="col-xs-12">
                                    ...
                                    <asp:Button ID="Button1" runat="server" Text="Reset" class="btn btn-success btn-lg btn-block text-uppercase" OnClick="Button1_OnClick" />
                                </div>
                            </div>
                            <%--   <div class="form-group mb-10">
                                <div class="col-sm-12 text-center">
                                    <p>If you don't have an account? <a href="login.html" class="text-info ml-5"><b>Sign Up</b></a></p>
                                </div>
                            </div>--%>
                        </form>
                    </div>
