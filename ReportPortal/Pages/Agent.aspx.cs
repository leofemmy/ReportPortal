...
namespace ReportPortal
{
    public partial class Agent : System.Web.UI.Page
    {
        ...
        protected void btnpreview_OnClick(object sender, EventArgs e)
        {
            ...
            if (Extension.GetRecordcounts(String.Format("SELECT * FROM ViewTaxAgent WHERE MerchantCode='{0}' AND Datecreated BETWEEN '{1}' AND '{2}' ORDER BY OrganizationName ASC", sessions.MerchantCode.ToString(), gb, gb2)))
            {
