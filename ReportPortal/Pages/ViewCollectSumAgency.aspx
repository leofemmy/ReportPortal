<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewCollectSumAgency.aspx.cs" Inherits="ReportPortal.ViewCollectSumAgency" %>
     ...
     <script type="text/javascript" id="script">
         function previewClick(s, e) {
             ...
             if (e.Brick.text() != null) {
                 window.location.href = "ViewCollectSummaryAgencyChild.aspx"
             }
         }
    </script>
</head>
