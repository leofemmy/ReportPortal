<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewTccLineYearSummary.aspx.cs" Inherits="ReportPortal.ViewTccLineYearSummary" %>
    ...
    <script type="text/javascript" id="script">
        function previewClick(s, e) {
            ...
            if (e.Brick.text() != null) {
                window.location.href = "ViewTccLineYearSummaryChild.aspx"
            }
        }
    </script>
</head>
