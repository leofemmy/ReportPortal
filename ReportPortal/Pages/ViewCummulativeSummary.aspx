<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewCummulativeSummary.aspx.cs" Inherits="ReportPortal.ViewCummulativeSummary" %>
    ...
    <script type="text/javascript" id="script">
        function previewClick(s, e) {
            ...
            if (e.Brick.text() != null) {
                window.location.href = "ViewCummulativeSummaryChild.aspx"
            }
        }
    </script>
</head>
