...
{
    public partial class ViewLineSummaryChilde : System.Web.UI.Page
    {
        ...
        void calReport()
        {
            ...
            string strquery = String.Format("SELECT * FROM dbo.ViewPayerLedger  where PayerUtin='{0}' AND AssessmentYear BETWEEN {1} AND {2} AND RevenueOfficeID={3}", vastin, varyear, varto, vrreveune);
