<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewTCCGeneralSummaryTaxoffice.aspx.cs" Inherits="ReportPortal.ViewTCCGeneralSummaryTaxoffice" %>
    ...
    <script type="text/javascript" id="script">
        function previewClick(s, e) {
            ...
            if (e.Brick.text() != null) {
                window.location.href = "ViewTCCGeneralSummaryTaxofficeChild.aspx"
            }
        }
    </script>
</head>
