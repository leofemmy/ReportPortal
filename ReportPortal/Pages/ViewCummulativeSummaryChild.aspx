<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewCummulativeSummaryChild.aspx.cs" Inherits="ReportPortal.ViewCummulativeSummaryChild" %>
    ...
    <script type="text/javascript" id="script">
        function previewClick(s, e) {
            ...
            if (e.Brick.text() != null) {
                window.location.href = "ViewCummulativeSummaryChildDetails.aspx"
            }
        }
    </script>
</head>
