<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewTccLineSummaryAll.aspx.cs" Inherits="ReportPortal.ViewTccLineSummaryAll" %>
    ...
    <script type="text/javascript" id="script">
        function previewClick(s, e) {
            ...
            if (e.Brick.text() != null) {
                window.location.href = "ViewTccLineSummaryAllChild.aspx"
            }
        }
    </script>
</head>
