<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewAssessmentCummulativeSummary.aspx.cs" Inherits="ReportPortal.ViewAssessmentCummulativeSummary" %>
    ...
    <script type="text/javascript" id="script">
        function previewClick(s, e) {
            ...
            if (e.Brick.text() != null) {
                window.location.href = "ViewAssessmentCummulativeSummaryChild.aspx"
            }
        }
    </script>
</head>
