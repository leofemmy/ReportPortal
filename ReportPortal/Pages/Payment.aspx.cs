...
namespace ReportPortal
{
    public partial class Payment : System.Web.UI.Page
    {
        ...
        protected void btnpreview_OnClick(object sender, EventArgs e)
        {
            ...
            if (Extension.GetRecordcounts(String.Format("SELECT * FROM ViewPayment WHERE PaymentDate BETWEEN '{0}' AND '{1}' and RevenueCode ='{2}' ORDER BY PaymentDate ASC", startdate, enddate, strrevenue)))
            {
