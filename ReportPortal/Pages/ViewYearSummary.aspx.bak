<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewYearSummary.aspx.cs" Inherits="ReportPortal.ViewYearSummary" %>
    ...
    <script type="text/javascript" id="script">
        function previewClick(s, e) {
            ...
            if (e.Brick.text() != null) {
                window.location.href = "ViewYearLineSummary.aspx"
            }
        }
    </script>
</head>
