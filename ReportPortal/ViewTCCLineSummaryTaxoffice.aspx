<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewTCCLineSummaryTaxoffice.aspx.cs" Inherits="ReportPortal.ViewTCCLineSummaryTaxoffice" %>
    ...
    <script type="text/javascript" id="script">
        function previewClick(s, e) {
            ...
            if (e.Brick.text() != null) {
                window.location.href = "ViewTCCLineSummaryTaxofficeChild.aspx"
            }
        }
    </script>
</head>
