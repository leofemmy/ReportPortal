<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewSummarySelfemploye.aspx.cs" Inherits="ReportPortal.ViewSummarySelfemploye" %>
    ...
    <script type="text/javascript" id="script">
        function previewClick(s, e) {
            ...
            if (e.Brick.text() != null) {
                window.location.href = "ViewSummarySelfemployedetails.aspx"
            }
        }
    </script>
</head>
