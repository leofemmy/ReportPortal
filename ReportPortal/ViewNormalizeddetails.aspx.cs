...
{
    public partial class ViewNormalizeddetails : System.Web.UI.Page
    {
        ...
        void calReport()
        {
            ...
            XtraRepNormalisedDetails obj_Rpt = new XtraRepNormalisedDetails();
            ...
            string strquery = String.Format("SELECT * FROM ViewNormalizedPayment  WHERE PaymentDate BETWEEN '{0}' AND '{1}' AND RevenueName = '{2}' GROUP BY RevenueCode, RevenueName ORDER BY  RevenueName ASC", startdate, enddate, vragencyname);
