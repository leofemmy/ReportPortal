<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewTaxOfficeSummary.aspx.cs" Inherits="ReportPortal.ViewTaxOfficeSummary" %>
    ...
    <script type="text/javascript" id="script">
        function previewClick(s, e) {
            ...
            if (e.Brick.text() != null) {
                window.location.href = "ViewTaxofficeLinesummary.aspx"
            }
        }
    </script>
</head>
