<%@ Page Title="" Language="C#" MasterPageFile="~/PortalSite.Master" AutoEventWireup="true" CodeBehind="Business.aspx.cs" Inherits="ReportPortal.Business" %>
        ...
        <div class="col-sm-12 col-xs-12">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Business Sectors  </h6>
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="form-wrap">
                            <form class="form-horizontal" runat="server">
                                ...
                                <div>
                                    <asp:Label ID="Label1" class="control-label mb-10 col-sm-2" runat="server" Text="Business Name List" Width="200px"></asp:Label>
                                    <div class="col-sm-6 col-xs-12 form-group" style="height: 650px; width: 500px; overflow: auto; position: relative; overflow-x: hidden; overflow-y: auto;">
                                        ...
                                        <table id="tbloffice" class="table table-striped table-bordered table-hover responsive" style="width: 80%">
                                            <thead>
                                                <tr>
                                                    <th>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#tbloffice').dataTable().fnClearTable();
                    $('#tbloffice').dataTable().fnDraw();
                    $('#tbloffice').dataTable().fnDestroy();

                    console.log(jsdata.Table);

                    if ((jsdata.Table.length != 0)) {
                        table = $('#tbloffice').DataTable({
                            bLengthChange: false,
            ...
            $('#tbloffice tbody').on('change', 'input[type="checkbox"]', function () {
            ...
            $('#btnpreview').on('click', function () {
                if ($('#<%=txtstartdate.ClientID%>').val() == 0) {
                    ...
                    if (rows_selected == "") {
                        swal("Report Portal", "Business Name Not Selected!!", "info");
                    } else {
                        var obj = {};

                        obj.startdate = $.trim($('#<%=txtstartdate.ClientID%>').val());
                        obj.enddate = $.trim($('#<%=txtenddate.ClientID%>').val());
                        obj.officeid = rows_selected;

                        $.ajax({
                            type: "POST",
                            url: "Business.aspx/PostPreview",
                            ...
                            success: function (r) {
                                ...
                                if (jsdata == '1') {
                                    window.open('ViewBusiness.aspx', '_blank');
                                } else {
