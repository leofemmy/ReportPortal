...
{
    public partial class ViewAssessmentTaxOfficeYear : System.Web.UI.Page
    {
        ...
        void calReport()
        {
            ...
            XtraRepAssessmentTaxOfficeYear obj_Rpt = new XtraRepAssessmentTaxOfficeYear();
        ...
        {
            ViewAssessmentTaxOfficeYear vp = new ViewAssessmentTaxOfficeYear();
