...
$('#select-methods').multiSelect();
$('#select-all').on('click', function(){
$('#select-methods').multiSelect('select_all');
return false;
});
$('#deselect-all').on('click', function(){
$('#select-methods').multiSelect('deselect_all');
return false;
});
$('#refresh').on('click', function(){
$('#select-methods').multiSelect('refresh');
return false;
});
$('#add-option').on('click', function(){
$('#select-methods').multiSelect('addOption', { value: 42, text: 'test 42', index: 0 });
return false;
});
