<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewAssessmentTaxOfficeYear.aspx.cs" Inherits="ReportPortal.ViewAssessmentTaxOfficeYear" %>
    ...
    <script type="text/javascript" id="script">
        function previewClick(s, e) {
            ...
            if (e.Brick.text() != null) {
                window.location.href = "ViewAssessmentTaxOfficeYearChild.aspx"
            }
        }
    </script>
</head>
